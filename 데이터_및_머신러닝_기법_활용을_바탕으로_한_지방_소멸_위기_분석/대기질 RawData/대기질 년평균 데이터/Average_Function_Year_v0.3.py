...
file_path = 'C:/Users/YS702/Desktop/LAST_PROJECT/대기질__RawData_월별대기오염도(측정망별,시도별,도시별,측정지점별)/미세먼지(PM2.5)/미세먼지(PM2.5)_월별대기오염도_RawData_v0.2.xlsx'
...
# 결과를 새로운 데이터 프레임에 저장합니다.
average_df = df[['구분', '항목','2015_평균','2016_평균','2017_평균','2018_평균', '2019_평균', '2020_평균']]

# 결과를 엑셀 파일로 저장합니다.
output_file_path = 'C:/Users/YS702/Desktop/LAST_PROJECT/미세먼지(PM2.5)_년별대기오염도_RawData_v0.2.xlsx'
average_df.to_excel(output_file_path, index=False)
